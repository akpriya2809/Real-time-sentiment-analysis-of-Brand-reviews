...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str,
                        default='/Users/akankshapriya/PycharmProjects/Real-Time-Sentiment-Analysis/Real-Time-sentiment-analysis-of-Brand-reviews/scraping/scrapy/trustpilot/comments_trustpilot_en.csv')
